<template>
  <div class="overlay" id="formDetail" v-if="isShowForm">
    <Vue3DraggableResizable :initW="833" :initH="596" :x="x" :y="y" :w="w" :h="h" :active="active" :draggable="true"
      :resizable="false" :parent="false" @activated="print('activated')" @deactivated="print('deactivated')"
      ...
      <div class="content-center">
        <div class="content-center-box">
          ...
          <div class="box-row">
            ...
            <BaseCombobox class="form-combobox" :data="products" :IdName="'ProductID'" :ValName="'ProductName'"
              :value="'3304dddb-1b72-607f-25c2-579daad24557'" @changeValue="changeStatusID"></BaseCombobox>
          </div>
          <div class="box-row">
            <span>Áp dụng cho<span>(*)</span></span>
            <BaseCombobox class="form-combobox" :data="ComboboxData.Applicable" :IdName="'Id'" :ValName="'Label'"
              :value="applicableID" @changeValue="changeStatusID"></BaseCombobox>
          </div>
          <div class="box-row">
          ...
          <div class="box-row">
            <span>Áp dụng cho<span>(*)</span></span>
            <input type="radio" class="box-radio" name="applyFor">
          ...
          <div class="box-row">
            ...
            <BaseCombobox class="form-combobox" :data="ComboboxData.Category" :IdName="'Id'" :ValName="'Label'"
              :value="categoryID" @changeValue="changeCategoryID"></BaseCombobox>
          </div>
          <div class="box-row">
            <span>Cấp xin duyệt giảm giá:</span>
            <input type="radio" class="box-radio" name="level">
        ...
        <div class="content-center-box">
          ...
          <div class="box-row">
            ...
            <el-date-picker :clearable="false" size="small" class="el-date-picker" v-model="date" type="date"
              popper-class="el-date-picker-popper" :max="todayDate" placeholder="DD/MM/YYYY" format="DD/MM/YYYY"
